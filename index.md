il# The Matrix: connecting and re-using digital records and archives of archaeological investigations
...
## Introductory Video recording from a Research Seminar on The Matrix Project presented for MOLA archaeologists on 15-07-2021 - opens in YouTube
...
## <a name="a">Archaeological Process & Data Modelling
...
The Prototype _**is not intended currently to be a commercially supported**_ Matrix recording and Stratigraphic Phasing analysis and archiving software.  It would need more development and administrative work to make it available and updated e.g. as Open and FAIR software through an online tool with suitable registration for an archaeological community of users.
...
![Matrix: Copyright CC_by Wikipedia](/images/Digital_rain_animation_medium_letters_shine.gif) 
  _CC_by Wikipedia_
